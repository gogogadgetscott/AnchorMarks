...
async function loadConfig() {
    const stored = await chrome.storage.local.get(['anchormarks_config', 'anchormarks_config']);
    if (stored.anchormarks_config && !stored.anchormarks_config) {
        await chrome.storage.local.set({ anchormarks_config: stored.anchormarks_config });
