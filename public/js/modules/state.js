...
export function setCsrfToken(val) {
  csrfToken = val;
}
...
export function setCurrentDashboardTab(val) {
...
export function setSnapToGrid(val) {
  snapToGrid = val;
}
export function setDashboardConfig(val) {
  dashboardConfig = val;
}
export function setWidgetOrder(val) {
  widgetOrder = val;
}
export function setDashboardWidgets(val) {
  dashboardWidgets = val;
}
export function setCollapsedSections(val) {
  collapsedSections = val;
}
export function setFilterConfig(val) {
  filterConfig = val;
}
export function setLastSelectedIndex(val) {
  lastSelectedIndex = val;
}
export function setBulkMode(val) {
  bulkMode = val;
}
export function setCommandPaletteOpen(val) {
  commandPaletteOpen = val;
}
export function setCommandPaletteEntries(val) {
  commandPaletteEntries = val;
}
export function setCommandPaletteActiveIndex(val) {
  commandPaletteActiveIndex = val;
}
export function setTourState(val) {
  tourState = val;
}
export function setLastTagRenameAction(val) {
  lastTagRenameAction = val;
}
export function setIsInitialLoad(val) {
  isInitialLoad = val;
}
export function setDisplayedCount(val) {
  displayedCount = val;
}
export function setIsLoadingMore(val) {
  isLoadingMore = val;
}
export function setDraggedWidget(val) {
  draggedWidget = val;
}
export function setDraggedSidebarItem(val) {
  draggedSidebarItem = val;
}
export function setIsDraggingWidget(val) {
  isDraggingWidget = val;
}
export function setDragStartPos(val) {
  dragStartPos = val;
}
export function setWidgetStartPos(val) {
  widgetStartPos = val;
}
export function setIsResizing(val) {
  isResizing = val;
}
export function setResizingWidget(val) {
  resizingWidget = val;
}
export function setResizeStartSize(val) {
  resizeStartSize = val;
}
export function setSidebarPopout(val) {
  sidebarPopout = val;
}
export function setPopoutTimeout(val) {
  popoutTimeout = val;
}
export function setTagSuggestTimeout(val) {
  tagSuggestTimeout = val;
}
export function setAllSidebarTags(val) {
  allSidebarTags = val;
}
export function setShowingAllTags(val) {
  showingAllTags = val;
}
