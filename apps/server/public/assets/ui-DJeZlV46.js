    ...
    <div class="rich-bookmark-card ${i ? "selected" : ""} entrance-animation ${l}" data-id="${n.id}" data-index="${t}">
      ...
      <div class="rich-card-content">
        <div class="rich-card-header">
          <div class="bookmark-favicon">${c}</div>
    ...
    <div class="user-profile-menu ${s}">
      ...
      <div class="user-dropdown-menu hidden header-user-dropdown">
        <div class="user-dropdown-header">
          <div class="user-avatar large header-user-avatar-large">${e}</div>
          <div class="user-dropdown-info">
            <span class="user-name header-user-name">${t}</span>
            <span class="user-plan">${o}</span>
          </div>
        </div>
...
`,
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-section">
      <div class="nav-item" data-view="dashboard" data-tooltip="Dashboard">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
        ...
        <span>Dashboard</span>
        <span class="badge" id="dashboard-count">0</span>
      </div>
      <div class="nav-item active" data-view="all" data-tooltip="Bookmarks">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
      ...
      <div class="nav-item" data-view="favorites" data-tooltip="Favorites">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
      ...
      <div class="nav-item" data-view="recent">
        ...
        <span>Recent</span>
        <span class="badge" id="count-recent">0</span>
      </div>
      <div class="nav-item" data-view="archived">
        ...
        <span>Archived</span>
        <span class="badge" id="count-archived">0</span>
      </div>
      <div class="nav-item" data-view="tag-cloud" data-tooltip="Tag Cloud">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
  ...
  <div class="sidebar-footer">
    ...
    >
      ...
      >
        <circle cx="12" cy="12" r="10" />
        <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3v1" />
...
`,
  ...
  <!-- Bulk Actions Bar (Injected by loader.js) -->
  <div id="bulk-bar-container"></div>

  <div class="content-body">
    <div
      id="smart-insights-widget"
      class="smart-insights-widget"
      style="display: none"
    ></div>
    ...
    <!-- Empty State (Injected by loader.js) -->
...
`,
  ...
  <div class="bulk-left">
    ...
    <button
      ...
      data-action="bulk-unselect-all"
    >
      Unselect All
    </button>
  </div>
  <div class="bulk-actions">
    <button class="btn btn-ghost" id="bulk-favorite-btn">Favorite</button>
    <button class="btn btn-secondary" id="bulk-tag-btn">Tag</button>
    <button class="btn btn-ghost" id="bulk-untag-btn">Remove Tags</button>
    <div class="bulk-move">
      <select id="bulk-move-select"></select>
      <button class="btn btn-secondary" id="bulk-move-btn">Move</button>
    </div>
  ...
  <div class="modal-content modal-sm">
    ...
    <form id="tag-form">
      ...
      <div class="form-group">
        ...
        <input type="text" id="tag-name" required placeholder="design" />
      </div>
      <div class="form-group">
        <label>Color</label>
        <div class="color-picker-tag">
          <button
            type="button"
            class="color-option-tag active"
            style="--color: #f59e0b"
            data-color="#f59e0b"
          ></button>
          <button
        ...
        <input type="hidden" id="tag-color" value="#f59e0b" />
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary modal-cancel">
          Cancel
  ...
  <div class="modal-content modal-sm">
    ...
    <form id="folder-form">
      ...
      <div class="form-group">
        ...
        <input type="hidden" id="folder-color" value="#6366f1" />
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary modal-cancel">
          Cancel
...
`,
  ...
  <div class="filter-content">
    ...
    <div class="filter-section">
      ...
      <div class="selected-tags" id="filter-selected-tags">
        <!-- Selected tags will appear here -->
        <span
          class="text-tertiary"
          style="font-size: 0.875rem; font-style: italic"
          id="filter-no-tags"
    ...
    <div class="filter-section">
      ...
      />
      <div id="filter-available-tags" class="available-tags-list">
        <!-- Available tags list -->
      </div>
      <div id="filter-tags-empty" class="tags-empty-state hidden">
        <p>No tags created yet</p>
        <p class="text-tertiary">
          Add tags to your bookmarks to filter by them
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="settings-content">
      ...
      <div class="settings-panel" id="settings-sync">
        <div class="sync-info">
          ...
          <p>
            Install our browser extension to sync your bookmarks automatically
          </p>
          <div class="extension-buttons">
            <a href="#" class="btn btn-secondary" target="_blank">
              ...
              >
                <path
                  d="M12 0C8.21 0 4.831 1.757 2.632 4.501l3.953 6.848A5.454 5.454 0 0 1 12 6.545h10.691A12 12 0 0 0 12 0zM1.931 5.47A11.943 11.943 0 0 0 0 12c0 6.012 4.42 10.991 10.189 11.864l3.953-6.847a5.45 5.45 0 0 1-6.865-2.29zm13.342 2.166a5.446 5.446 0 0 1 1.45 7.09l.002.001h-.002l-3.952 6.848a12.014 12.014 0 0 0 9.229-4.364 11.963 11.963 0 0 0 2-9.575zm-3.091 1.637a2.727 2.727 0 1 0 0 5.454 2.727 2.727 0 0 0 0-5.454z"
                />
              </svg>
              Chrome
            </a>
            <a href="#" class="btn btn-secondary" target="_blank">
              ...
              >
                <path
                  d="M21.86 17.86q.14 0 .25.12.1.13.1.25t-.11.33l-.32.46-.43.53-.44.5q-.21.25-.38.42l-.22.23q-.58.53-1.34 1.04-.76.51-1.6.88-.86.38-1.74.59-.87.21-1.63.21-1.78 0-3.35-.68-1.58-.68-2.79-1.88-1.21-1.21-1.9-2.79Q6.3 15.63 6.3 13.85q0-1.88.7-3.53.71-1.66 1.93-2.92Q10.16 6.14 11.82 5.38q1.66-.75 3.54-.76.88 0 1.75.22.88.21 1.74.59.85.38 1.61.89.76.51 1.34 1.05.57.53.66.63.15.15.15.33 0 .13-.1.25-.1.12-.25.12h-9.6q-.38 0-.71.16-.33.15-.58.43-.24.27-.38.64-.14.36-.14.77 0 .41.14.78.14.37.38.64.25.27.58.43.33.16.71.16z"
                />
              </svg>
              Edge
            </a>
            <a href="#" class="btn btn-secondary" target="_blank">
              ...
              >
                <path
                  d="M12.006 16.52c-.263 0-.526-.017-.788-.054a5.606 5.606 0 01-3.039-1.586l-.078-.071a5.536 5.536 0 01-1.188-1.735 5.516 5.516 0 01-.433-2.136 5.606 5.606 0 011.586-3.905l.071-.078a5.536 5.536 0 011.735-1.188c.688-.3 1.41-.452 2.136-.452a5.606 5.606 0 013.905 1.586l.078.071a5.536 5.536 0 011.188 1.735c.3.688.452 1.41.452 2.136a5.606 5.606 0 01-1.586 3.905l-.071.078a5.536 5.536 0 01-1.735 1.188 5.516 5.516 0 01-2.136.452c-.003.054-.097.054-.097.054z"
                />
              </svg>
              Firefox
            </a>
      ...
      <div class="settings-panel" id="settings-import">
        ...
        <div class="import-section">
          ...
          <p>Export or import your saved dashboard layouts</p>
          <div class="export-options">
            <button class="btn btn-secondary" id="export-dashboard-views-btn">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            <input
              type="file"
              id="import-dashboard-views-file"
              accept=".json"
              hidden
            />
            <button class="btn btn-secondary" id="import-dashboard-views-btn">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            <div
              id="import-dashboard-views-progress"
              class="import-progress"
              aria-live="polite"
            ></div>
          </div>
      ...
      <div class="settings-panel" id="settings-tags">
        ...
        <div class="nav-section collapsible hidden" id="tags-section">
          <div class="setting-info" style="margin-bottom: 10px">
            ...
            <p>
              Move all uses of one tag to another (use “parent/child” for
              hierarchy)
            </p>
          </div>
          <div class="form-row">
          ...
          <div style="display: flex; gap: 0.5rem; align-items: center">
            ...
            <span class="text-tertiary" style="font-size: 0.9rem"
              >Example: dev/js → dev/frontend/js</span
            >
          </div>
        </div>
      </div>
...
`,
  ...
  <div class="shortcuts-popup-panel">
    <div class="shortcuts-popup-header">
      ...
      <button class="btn-icon shortcuts-popup-close" id="shortcuts-popup-close">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
    ...
    <div class="shortcuts-popup-content">
      <div class="shortcuts-group">
        ...
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+Shift+D</kbd></div>
          <div class="shortcut-label">Dashboard</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+Shift+F</kbd></div>
          <div class="shortcut-label">Favorites</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+Shift+A</kbd></div>
          <div class="shortcut-label">All Bookmarks</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+1</kbd>–<kbd>9</kbd></div>
          <div class="shortcut-label">Jump to Folder</div>
        </div>
      </div>
      ...
      <div class="shortcuts-group">
        <h3>Bookmarks</h3>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+N</kbd></div>
          <div class="shortcut-label">Add Bookmark</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+F</kbd></div>
          <div class="shortcut-label">Search</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+A</kbd></div>
          <div class="shortcut-label">Select All</div>
        </div>
      </div>
      ...
      <div class="shortcuts-group">
        <h3>General</h3>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Ctrl+Shift+P</kbd></div>
          <div class="shortcut-label">Command Palette</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>F11</kbd></div>
          <div class="shortcut-label">Fullscreen (Dashboard)</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Shift+/</kbd> or <kbd>></kbd></div>
          <div class="shortcut-label">Help (this menu)</div>
        </div>
        <div class="shortcut-item">
          <div class="shortcut-keys"><kbd>Esc</kbd></div>
          <div class="shortcut-label">Close/Cancel</div>
        </div>
      </div>
      ...
      <div class="shortcuts-info">
        ...
        <a
          href="/help.html#shortcuts"
          target="_blank"
          class="shortcuts-help-link"
        >
...
`,
  ...
  <div class="quick-launch-panel">
    ...
    <input
      type="text"
      id="quick-launch-input"
      placeholder="Search bookmarks, folders, or type > for commands..."
      autocomplete="off"
    />
    <div class="quick-launch-tips">
      <span class="tip">Type to search bookmarks</span>
      <span class="tip"><kbd>></kbd> commands</span>
      <span class="tip"><kbd>@</kbd> folders</span>
      <span class="tip"><kbd>#</kbd> tags</span>
    </div>
...
<div id="tour-popover" class="tour-popover hidden">
  <div class="tour-header">
    <div class="tour-steps">
      ...
      <span class="tour-step" id="tour-step-2">2</span>
      <span class="tour-step" id="tour-step-3">3</span>
    </div>
    <button class="btn-icon tour-close" data-action="skip-tour">
      <svg
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
  ...
  <div class="tour-actions">
    <button class="btn btn-secondary tour-skip" data-action="skip-tour">
      Skip
    </button>
