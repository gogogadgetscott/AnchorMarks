...
export function applyFaviconSetting(): void {
    const toggle = document.getElementById("hide-favicons-toggle") as HTMLInputElement;
    if (toggle) toggle.checked = state.hideFavicons;

    const aiToggle = document.getElementById("ai-suggestions-toggle") as HTMLInputElement;
    if (aiToggle) aiToggle.checked = state.aiSuggestionsEnabled;

    const childToggle = document.getElementById("include-children-toggle") as HTMLInputElement;
...
export function toggleAiSuggestions(): void {
    const toggle = document.getElementById("ai-suggestions-toggle") as HTMLInputElement;
    const newValue = toggle?.checked !== false;
...
export function toggleIncludeChildBookmarks(): void {
    const toggle = document.getElementById("include-children-toggle") as HTMLInputElement;
    const newValue = toggle?.checked || false;
