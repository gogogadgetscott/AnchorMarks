  ...
  <form id="login-form" class="auth-form" method="post" autocomplete="on">
    ...
    <div class="form-group">
      <div class="form-label-row">
        ...
        <button type="button" class="forgot-password-link" id="forgot-password-btn">Forgot password?</button>
      </div>
  ...
  <form id="register-form" class="auth-form hidden" method="post" autocomplete="on">
    ...
    <div class="form-group">
      ...
      <div class="password-input-wrapper">
        ...
        />
        <button type="button" class="password-toggle" aria-label="Show password" data-target="register-password">
          <svg class="eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
            <circle cx="12" cy="12" r="3"/>
          </svg>
    ...
    <div class="form-group">
      ...
      <div class="password-input-wrapper">
        <input
          ...
          autocomplete="new-password"
        />
        <button type="button" class="password-toggle" aria-label="Show password" data-target="register-confirm-password">
          <svg class="eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
            <circle cx="12" cy="12" r="3"/>
          </svg>
      ...
      <span class="confirm-password-error hidden" id="confirm-password-error">Passwords do not match</span>
    </div>
    <button type="submit" class="btn btn-primary btn-full">
