...
function PickerItem({
    ...
    return (
        ...
        >
            ...
            {count !== undefined && <span className="filter-item-count">{count}</span>}
            {isAdded && (
                <span
                    style={{
                        fontSize: "0.65rem",
...
export function WidgetPicker() {
    ...
    }, [isPinned, setIsWidgetPickerOpen]);
    ...
    const filteredFolders = useMemo(() => {
        ...
        return baseFolders.filter((f) => f.name.toLowerCase().includes(term));
                ...
                <div className="filter-dropdown-actions">
                    <button
                        ...
                        onClick={() => {
                            ...
                            showToast(`Widget picker ${!isPinned ? "pinned" : "unpinned"}`, "success");
                        }}
                    >
                        <svg
                            viewBox="0 0 512 512"
                    ...
                    <div className="filter-column">
                        ...
                        >
                            {folderTree.length > 0 ? (
                                ...
                                <p style={{ color: "var(--text-tertiary)", fontSize: "0.875rem", padding: "1rem" }}>
                                    No folders found
                                </p>
                            )}
                        </div>
