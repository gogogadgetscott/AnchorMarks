...
export const Header = memo<HeaderProps>(({
  ...
  const { viewMode, setViewMode, selectedBookmarks, clearSelection } = useAppState();
      ...
      {hasSelection ? (
        <div className="header-selection-ui">
          ...
          <div className="selection-actions">
            <Button variant="secondary" icon={<Icon name="archive" size={16} />}>
              Archive
            </Button>
            <Button variant="secondary" icon={<Icon name="folder" size={16} />}>
              Move
            </Button>
