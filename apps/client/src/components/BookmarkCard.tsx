...
import { getHostname, getBaseUrl } from "@utils/index.ts";
...
export function BookmarkCard({
  ...
  const { viewMode, hideFavicons } = useUI();
  ...
  return (
    <div
      className={`bookmark-card ${isSelected ? "selected" : ""} ${bookmark.color ? "has-custom-color" : ""} entrance-animation ${delayClass}`}
      data-id={bookmark.id}
      data-index={index}
      style={colorStyle}
      role="listitem"
    ...
    >
      ...
      {viewMode === "list" ? (
        <>
          <div className="bookmark-col bookmark-favicon">{favicon}</div>
          <div className="bookmark-col bookmark-title-tags">
          ...
          <div className="bookmark-col bookmark-desc-url">
            <div className="bookmark-description">
              {bookmark.description ?? ""}
            </div>
            <div className="bookmark-url" data-full-url={bookmark.url}>
              {displayUrl}
            </div>
          </div>
        </>
