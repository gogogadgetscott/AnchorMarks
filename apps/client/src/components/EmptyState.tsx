...
export function EmptyState() {
    ...
    const renderContent = () => {
        if (currentView === "favorites") {
            return (
                <div className="empty-state-content">
                    <Icon name="star" size={48} className="empty-state-icon" style={{ color: "var(--primary-400)" }} />
        ...
        if (currentView === "archived") {
            return (
                <div className="empty-state-content">
                    <Icon name="archive" size={48} className="empty-state-icon" style={{ color: "var(--text-tertiary)" }} />
        ...
        if (currentView === "recent") {
            return (
                <div className="empty-state-content">
                    <Icon name="clock" size={48} className="empty-state-icon" style={{ color: "var(--text-tertiary)" }} />
        ...
        if (currentView === "most-used") {
            return (
                <div className="empty-state-content">
                    <Icon name="activity" size={48} className="empty-state-icon" style={{ color: "var(--text-tertiary)" }} />
                    <h3>No visits yet</h3>
        ...
        if (filterConfig.tags.length > 0) {
            return (
                <div className="empty-state-content">
                    <Icon name="tag" size={48} className="empty-state-icon" style={{ color: "var(--text-tertiary)" }} />
                    <h3>No bookmarks with these tags</h3>
                    <p>No bookmarks match your selected tags.<br /><button className="btn-link" onClick={() => {/* TODO: Clear filters */ }}>Clear filters</button></p>
                </div>
            );
        }
        ...
        if (searchQuery) {
            return (
                <div className="empty-state-content">
                    <Icon name="search" size={48} className="empty-state-icon" style={{ color: "var(--text-tertiary)" }} />
                    <h3>No results found</h3>
                    <p>No bookmarks match "{searchQuery}".<br />Try a different search term.</p>
                </div>
            );
        }
        ...
        if (currentView === "folder" && currentFolder) {
            return (
                <div className="empty-state-content">
                    <Icon name="folder" size={48} className="empty-state-icon" style={{ color: "var(--text-tertiary)" }} />
        ...
        return (
            <div className="empty-state-content">
                <Icon name="link" size={48} className="empty-state-icon" style={{ color: "var(--primary-400)" }} />
